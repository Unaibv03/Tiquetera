...
<body>
    ...
    <div class="container my-3">
        <div class="card shadow-lg" id="evento-card" data-evento-id="11">
            <img 
                src="/img/recreativos.png" 
                class="card-img-top" 
            ...
            <div class="card-body">
                <h1 class="card-title text-center mb-4">Noche de recreativos</h1>

                <p class="card-text">
                    Un plan perfecto para todas las edades: luces, sonidos, y juegos para competir, reír y disfrutar. Desde las máquinas más modernas hasta los clásicos de siempre… ¡los recreativos tienen algo para todos!
                </p>
