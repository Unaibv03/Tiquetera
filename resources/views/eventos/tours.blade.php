...
<body>
    ...
    <div class="container my-3">
        <div class="card shadow-lg" id ="evento-card" data-evento-id="12">
            <img 
                src="/img/tour guiado.png" 
                class="card-img-top" 
            ...
            <div class="card-body">
                <h1 class="card-title text-center mb-4">Tour guiado</h1>

                <p class="card-text">
                    Explora con todos los sentidos. Nuestro tour guiado te llevará por lugares emblemáticos y llenos de historia, acompañado de explicaciones detalladas, contexto cultural y datos fascinantes que harán de tu visita una experiencia enriquecedora.
                </p>
